...
<span class="update-arrow">↗</span>
  ...
  <section class="home-section topics-section">
    <div class="section-heading">
      <div>
        <p class="eyebrow">Knowledge map · 03</p>
        <h2>探索主题</h2>
      </div>
    </div>
...
.featured-project {
  ...
  border-right: 1px solid rgba(246, 250, 255, 0.28);
  isolation: isolate;
}
...
.featured-project::before {
  ...
  right: -90px;
  top: -100px;
  border: 1px solid rgba(246, 250, 255, 0.22);
  border-radius: 50%;
  content: '';
...
.featured-project:hover::before {
  ...
  border-color: rgba(246, 250, 255, 0.5);
}
...
.featured-project:hover .project-display {
...
.project-actions {
  ...
  margin-top: 0.8rem;
  padding-top: 1rem;
  border-top: 1px solid rgba(246, 250, 255, 0.28);
}
...
.project-actions a {
  ...
  border: 1px solid rgba(246, 250, 255, 0.28);
  font-size: 0.72rem;
...
.project-directory > article {
  ...
  border-bottom: 1px solid rgba(246, 250, 255, 0.28);
  transition: background-color 200ms ease;
}

.project-directory > article:last-child {
  border-bottom: 0;
}

.project-directory > article:hover {
  background: var(--accent);
}
...
.project-index {
  grid-row: 1 / 3;
  align-self: center;
  color: rgba(246, 250, 255, 0.48);
  font-family: var(--font-editorial);
  font-size: 0.75rem;
  font-style: italic;
}

.project-directory strong {
  font-family: var(--font-mixed);
  font-size: 1.05rem;
  font-weight: 500;
}

.project-directory small {
  color: rgba(246, 250, 255, 0.56);
  font-size: 0.66rem;
}
...
@media (max-width: 900px) {
  ...
  .project-directory > article:nth-child(odd) {
    border-right: 1px solid rgba(246, 250, 255, 0.28);
  }

  .project-directory > article:nth-child(3) {
    border-bottom: 0;
  }
