import{_ as n,o as s,c as p,ag as t}from"./chunks/framework.-Wrcbzkw.js";const b=JSON.parse('{"title":"Prompt Chaining (提示链)","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/08_prompt_chaining_提示链.md","filePath":"LLM/Prompt Engineering/08_prompt_chaining_提示链.md","lastUpdated":1778837969000}'),e={name:"LLM/Prompt Engineering/08_prompt_chaining_提示链.md"};function l(i,a,r,d,c,o){return s(),p("div",null,[...a[0]||(a[0]=[t(`<h1 id="prompt-chaining-提示链" tabindex="-1">Prompt Chaining (提示链) <a class="header-anchor" href="#prompt-chaining-提示链" aria-label="Permalink to &quot;Prompt Chaining (提示链)&quot;">​</a></h1><p>将复杂任务拆分为多个步骤，逐步完成。</p><hr><h2 id="示例一-文章处理流水线" tabindex="-1">示例一：文章处理流水线 <a class="header-anchor" href="#示例一-文章处理流水线" aria-label="Permalink to &quot;示例一：文章处理流水线&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>第一步 - 文章总结：</span></span>
