import{_ as s,o as n,c as p,ag as e}from"./chunks/framework.-Wrcbzkw.js";const u=JSON.parse('{"title":"评估与迭代","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/21_evaluation_iteration_评估与迭代.md","filePath":"LLM/Prompt Engineering/21_evaluation_iteration_评估与迭代.md","lastUpdated":1778837435000}'),l={name:"LLM/Prompt Engineering/21_evaluation_iteration_评估与迭代.md"};function t(i,a,c,o,r,d){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="评估与迭代" tabindex="-1">评估与迭代 <a class="header-anchor" href="#评估与迭代" aria-label="Permalink to &quot;评估与迭代&quot;">​</a></h1><p>建立测试集、LLM打分、版本对比的完整流程。</p><hr><h2 id="为什么需要评估" tabindex="-1">为什么需要评估 <a class="header-anchor" href="#为什么需要评估" aria-label="Permalink to &quot;为什么需要评估&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>没有评估，就没有优化方向：</span></span>
