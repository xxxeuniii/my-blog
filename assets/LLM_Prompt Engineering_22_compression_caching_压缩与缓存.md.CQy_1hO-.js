import{_ as s,o as n,c as p,ag as e}from"./chunks/framework.-Wrcbzkw.js";const u=JSON.parse('{"title":"提示词压缩与缓存","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/22_compression_caching_压缩与缓存.md","filePath":"LLM/Prompt Engineering/22_compression_caching_压缩与缓存.md","lastUpdated":1778837435000}'),l={name:"LLM/Prompt Engineering/22_compression_caching_压缩与缓存.md"};function t(i,a,c,o,r,d){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="提示词压缩与缓存" tabindex="-1">提示词压缩与缓存 <a class="header-anchor" href="#提示词压缩与缓存" aria-label="Permalink to &quot;提示词压缩与缓存&quot;">​</a></h1><p>Token优化、降低延迟、成本控制。</p><hr><h2 id="为什么需要优化token" tabindex="-1">为什么需要优化Token <a class="header-anchor" href="#为什么需要优化token" aria-label="Permalink to &quot;为什么需要优化Token&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>成本因素：</span></span>
