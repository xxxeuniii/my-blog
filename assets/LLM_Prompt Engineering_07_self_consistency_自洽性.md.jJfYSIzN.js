import{_ as a,o as n,c as p,ag as e}from"./chunks/framework.-Wrcbzkw.js";const u=JSON.parse('{"title":"Self-Consistency (自洽性)","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/07_self_consistency_自洽性.md","filePath":"LLM/Prompt Engineering/07_self_consistency_自洽性.md","lastUpdated":1778766566000}'),l={name:"LLM/Prompt Engineering/07_self_consistency_自洽性.md"};function i(t,s,c,o,r,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="self-consistency-自洽性" tabindex="-1">Self-Consistency (自洽性) <a class="header-anchor" href="#self-consistency-自洽性" aria-label="Permalink to &quot;Self-Consistency (自洽性)&quot;">​</a></h1><p>多路径推理，取最一致的答案。</p><hr><h2 id="示例一-数学计算验证" tabindex="-1">示例一：数学计算验证 <a class="header-anchor" href="#示例一-数学计算验证" aria-label="Permalink to &quot;示例一：数学计算验证&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>问题：一家商店原价200元的商品，打8折后再降价15%，最终价格是多少？</span></span>
