import{_ as a,o as n,c as p,ag as t}from"./chunks/framework.-Wrcbzkw.js";const d=JSON.parse('{"title":"结构化输出（JSON格式）","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/03_json_结构化输出.md","filePath":"LLM/Prompt Engineering/03_json_结构化输出.md","lastUpdated":1780650181000}'),e={name:"LLM/Prompt Engineering/03_json_结构化输出.md"};function l(o,s,i,u,c,q){return n(),p("div",null,[...s[0]||(s[0]=[t(`<h1 id="结构化输出-json格式" tabindex="-1">结构化输出（JSON格式） <a class="header-anchor" href="#结构化输出-json格式" aria-label="Permalink to &quot;结构化输出（JSON格式）&quot;">​</a></h1><p>要求模型返回 JSON，便于程序处理。</p><hr><h2 id="示例一-简历信息提取" tabindex="-1">示例一：简历信息提取 <a class="header-anchor" href="#示例一-简历信息提取" aria-label="Permalink to &quot;示例一：简历信息提取&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>请从以下文本中提取信息，返回JSON格式：</span></span>
