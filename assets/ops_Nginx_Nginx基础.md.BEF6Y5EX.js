import{_ as i,o as a,c as n,ag as p}from"./chunks/framework.-Wrcbzkw.js";const g=JSON.parse('{"title":"Nginx 基础","description":"","frontmatter":{},"headers":[],"relativePath":"ops/Nginx/Nginx基础.md","filePath":"ops/Nginx/Nginx基础.md","lastUpdated":1780648620000}'),l={name:"ops/Nginx/Nginx基础.md"};function h(t,s,e,k,r,d){return a(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="nginx-基础" tabindex="-1">Nginx 基础 <a class="header-anchor" href="#nginx-基础" aria-label="Permalink to &quot;Nginx 基础&quot;">​</a></h1><p>Nginx 是一个高性能的 HTTP 服务器和反向代理服务器。</p><h2 id="一、常用命令" tabindex="-1">一、常用命令 <a class="header-anchor" href="#一、常用命令" aria-label="Permalink to &quot;一、常用命令&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 启动</span></span>
