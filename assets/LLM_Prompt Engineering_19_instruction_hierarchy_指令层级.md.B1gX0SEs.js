import{_ as s,o as n,c as p,ag as e}from"./chunks/framework.-Wrcbzkw.js";const u=JSON.parse('{"title":"Instruction Hierarchy (指令层级)","description":"","frontmatter":{},"headers":[],"relativePath":"LLM/Prompt Engineering/19_instruction_hierarchy_指令层级.md","filePath":"LLM/Prompt Engineering/19_instruction_hierarchy_指令层级.md","lastUpdated":1778837350000}'),l={name:"LLM/Prompt Engineering/19_instruction_hierarchy_指令层级.md"};function i(t,a,c,r,o,h){return n(),p("div",null,[...a[0]||(a[0]=[e(`<h1 id="instruction-hierarchy-指令层级" tabindex="-1">Instruction Hierarchy (指令层级) <a class="header-anchor" href="#instruction-hierarchy-指令层级" aria-label="Permalink to &quot;Instruction Hierarchy (指令层级)&quot;">​</a></h1><p>区分不同来源指令的优先级。</p><hr><h2 id="背景问题" tabindex="-1">背景问题 <a class="header-anchor" href="#背景问题" aria-label="Permalink to &quot;背景问题&quot;">​</a></h2><p>当系统指令、用户指令、开发指令冲突时，模型应该如何处理？</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>系统指令：你是一个有帮助的助手</span></span>
